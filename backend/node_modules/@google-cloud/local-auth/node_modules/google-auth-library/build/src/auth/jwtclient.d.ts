...
import { CredentialBody, Credentials, JWTInput } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/credentials';
import { IdTokenProvider } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/idtokenclient';
import { GetTokenResponse, OAuth2Client, RefreshOptions, RequestMetadataResponse } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/oauth2client';
