...
import { DefaultTransporter, Transporter } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/transporters';
import { Compute } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/computeclient';
import { CredentialBody, ImpersonatedJWTInput, JWTInput } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/credentials';
import { IdTokenClient } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/idtokenclient';
import { GCPEnv } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/envDetect';
import { JWT, JWTOptions } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/jwtclient';
import { Headers, OAuth2ClientOptions, RefreshOptions } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/oauth2client';
import { UserRefreshClient, UserRefreshClientOptions } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/refreshclient';
import { Impersonated, ImpersonatedOptions } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/impersonated';
import { ExternalAccountClientOptions } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/externalclient';
import { BaseExternalAccountClient } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/baseexternalclient';
import { AuthClient } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/authclient';
import { ExternalAccountAuthorizedUserClient } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/externalAccountAuthorizedUserClient';
/**
