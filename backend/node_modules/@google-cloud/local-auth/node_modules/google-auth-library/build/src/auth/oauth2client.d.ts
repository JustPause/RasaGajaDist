...
import { JwkCertificate } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/crypto/crypto';
import { BodyResponseCallback } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/transporters';
import { AuthClient } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/authclient';
import { Credentials } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/credentials';
import { LoginTicket } from '@google-cloud/local-auth/node_modules/google-auth-library/build/src/auth/loginticket';
/**
