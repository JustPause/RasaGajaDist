...
import 'kleur/colors';
import { $ as $$LayoutSecondary } from './LayoutSecondary_CXM8OM0G.mjs';

const $$Astro = createAstro("https://rasagaja.lt");
const $$AudioBookLayout = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$AudioBookLayout;
...
}, "/home/justinas/Programming/RasoSvetaine/src/layouts/AudioBookLayout.astro", void 0);

export { $$AudioBookLayout as $ };
