import { _ as __astro_tag_component__, e as createVNode, F as Fragment } from '../../../chunks/astro/server_D3T3oDyi.mjs';
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.p, {
      ...
      children: ["„NEMUNAI TEKA Į DRAKONO KALNUS“ - t i k r a  istorija. Sraunia upe išsilieja mylinčios moters prisiminimai apie aktorių, režisierių, rašytoją  ", createVNode("spacing", {
        children: "Kęstutį"
      }), " ", createVNode("spacing", {
        children: "Marčiulyną"
