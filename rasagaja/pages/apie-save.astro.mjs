...
const $$ApieSave = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$LayoutSecondary, { "title": "Apie save" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex *:flex *:flex-col *:gap-10 *:items-center *:transition-all *:duration-300 *:w-1/3 *:h-full *:hover:gap-2 gap-56 mx-14 h-full justify-center"> <a href="/autoportretas" class="hover:pb-8 select-none"> <p class="header3">AUTOPORTRETAS</p> <img${addAttribute(Autoportretas_.src, "src")} alt="" srcset="" class="rounded-2xl pt-104 bg-[#FEFEFC]"> </a> <a href="/pedos-kelyje" class="hover:pt-8 select-none"> <img${addAttribute(Pedos_kelyja_.src, "src")} alt="" srcset="" class="rounded-2xl"> <p class="header3">PĖDOS KELYJE</p> </a> </div> ` })}`;
